...
public class TransitionBehaviour : StateMachineBehaviour
{
    ...
    private static readonly int in_Hash = Animator.StringToHash("In");
    private static readonly int out_Hash = Animator.StringToHash("Out");
    ...
    {
        if (back)
            animator.SetTrigger(out_Hash);
        else
            animator.SetTrigger(in_Hash);
